...
int main()
{
    ...
    // cout << "Enter Number of tea pack ";
    // cin >> numberOfTeaPack;
    // cout << "Enter price of tea pack ";
    // cin >> pricePerPack;

    // tax = (numberOfTeaPack * pricePerPack) * 0.1;
    // totalPrice = tax + (numberOfTeaPack * pricePerPack);

    // cout << "Totlal price is ";
    // cout << totalPrice;
    ...
    // bool isMemberFromOneYear;
    // cout<<"are you member for mor than a year press 1 for yes and 0 for no";
    // cin>>isMemberFromOneYear;

    // if (isMemberFromOneYear ||teaBags>12)
    // {
    //     cout<<"you are elegible for discount ";
    // }
    // else{
    //     cout<<"you are NOT  elegible for discount ";
    ...
    // nead to solv in future now able to solv it now correctly can just use k
    //     got form gpt as unable to solv this question
    //     #include <iostream>
    // using namespace std;

    // int main()
    // {
    //     int stock = 3; // 1 = Green, 2 = Black, 4 = Oolong
    //     int teaType;
